<template>
  <header class="header">
    <nav class="navbar">
      <!-- Navbar Title displayed only on /order/success -->
      <div v-if="isOrderSuccess" class="navbar__title">
      ...
      <!-- Other Navbar Elements hidden on /order/success -->
      <div v-if="!isOrderSuccess">
        ...
        >
          <div
            :class="{ 'navbar__toggle-bar': true, active: isMenuOpen }"
          ></div>
          <div
            :class="{ 'navbar__toggle-bar': true, active: isMenuOpen }"
          ></div>
...
const isOrderSuccess = computed(() => route.path === "/order/success"); // Check for /order/success
